...
- **Behavior**: The backend now dynamically scans the `lid_data/<serial>/crop/` folder to pull the original raw OCR serial crop. This raw crop is now proudly displayed at the top center of the generated PDF, followed by a 2x2 grid of the four zone images below it.
